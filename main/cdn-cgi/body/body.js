;
if (CloudflareApps.matchPage(CloudflareApps.installs['ymTYYgQwIVKb'].URLPatterns)) {
    (function() {
        "use strict"
        if (!window.addEventListener) return
        var options = CloudflareApps.installs['ymTYYgQwIVKb'].options
        var element
        ...
        function inIframe() {
            try {
                if ("ymTYYgQwIVKb" === 'preview') {
                    return window.top !== window.parent.parent
                }
        ...
        function updateElement() {
            ...
            if ((!inIframe()) && ("ymTYYgQwIVKb" === 'preview' || ((localStorageValid === false) || (localStorageValid === undefined)))) {
        ...
        window.CloudflareApps.installs['ymTYYgQwIVKb'].scope = {
